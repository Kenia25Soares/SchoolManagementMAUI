...
namespace SchoolManagementMAUI.Models
{
    public class StudentSubjectDetail
    {
        ...
        [JsonPropertyName("studentName")] public string? StudentName { get; set; }
        ...
        [JsonPropertyName("gradeDetails")] public List<StudentGradeDetail>? GradeDetails { get; set; }
        [JsonPropertyName("absenceDetails")] public List<StudentAbsenceDetail>? AbsenceDetails { get; set; }
    }
}
